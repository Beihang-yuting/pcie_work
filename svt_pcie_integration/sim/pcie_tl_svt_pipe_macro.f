//------------------------------------------------------------------------------
// 正式 SVT agent + TL-root adapter 双向 PIPE 门禁（DECLARE 宏路线）filelist。
//------------------------------------------------------------------------------

-sverilog
-timescale=1ns/1fs

// 通用 DECLARE 宏切换到 PIPE 展开
+define+PCIE_SVT_HDL_PHY_PIPE
...
+define+EXPERTIO_PCIESVC_GLOBAL_SHADOW_PATH=pcie_tl_svt_pipe_macro_top.global_shadow0
+define+SVC_RANDOM_SEED_SCOPE=pcie_tl_svt_pipe_macro_top.global_random_seed
