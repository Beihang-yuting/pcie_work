//------------------------------------------------------------------------------
// 正式 SVT agent + TL-root adapter 双向 PIPE 门禁 filelist。
//------------------------------------------------------------------------------
...
+define+EXPERTIO_PCIESVC_GLOBAL_SHADOW_PATH=pcie_tl_svt_pipe_top.global_shadow0
+define+SVC_RANDOM_SEED_SCOPE=pcie_tl_svt_pipe_top.global_random_seed
