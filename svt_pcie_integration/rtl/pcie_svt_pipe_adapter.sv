...
`define PCIE_SVT_PIPE_PORT_CROSS_X8(a, b) \
  `PCIE_SVT_PIPE_PORT_CROSS_X4(a, b) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 4) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 5) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 6) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 7)

`define PCIE_SVT_PIPE_PORT_CROSS_X16(a, b) \
  `PCIE_SVT_PIPE_PORT_CROSS_X8(a, b) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 8) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 9) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 10) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 11) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 12) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 13) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 14) \
  `PCIE_SVT_PIPE_PORT_CROSS_LANE(a, b, 15)
